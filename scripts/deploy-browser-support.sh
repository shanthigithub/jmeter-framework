...
echo "  - Selenium WebDriver 4.28.0"
...
echo ""
echo "3. To test browser support, create a test config:"
echo "   {\"testType\": \"browser\", \"testScript\": \"your-selenium-test.jmx\"}"
echo ""
...
echo ""
echo "  Cost Impact:"
echo "    API tests (testType: \"api\"): $0.025/test (unchanged)"
echo "    Browser tests (testType: \"browser\"): $0.048/test"
echo ""
echo "Happy Testing! 🎭"